...
if(correction)
    ...
    if(handles.ref==1)
        ...
        ARN_coloc(mask, s_ernacorrfile, as_ernacorrfile, mrnafile, k, threshold, pix_size,'Corr_');
    ...
    elseif(handles.ref==2)
        ...
        ARN_coloc(mask, s_ernafile, as_ernacorrfile, mrnacorrfile, k, threshold, pix_size,'Corr_');
    else
        ...
        ARN_coloc(mask, s_ernacorrfile, as_ernafile, mrnacorrfile, k, threshold, pix_size,'Corr_');
    end
end
